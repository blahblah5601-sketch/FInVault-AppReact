...
export default function DashboardPage({ accounts, budgets, vaults, setActivePage, activePage }) {
    ...
    <section id="dashboard" className="h-full flex flex-col overflow-hidden p-4">
      ...
      {navItems.map(item => (
          <a
            ...
            className={`nav-link flex items-center p-0 text-base font-normal rounded-lg ${
      ...
      <div className="flex-none flex flex-col items-center justify-center py-8 bg-background/30 rounded-3xl border border-white/5">
        <p className="text-base text-text-secondary uppercase tracking-widest" onClick={() => setActivePage('dashboard_simple')}>Active Account</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-bold flex justify-between items-center">
              Budgets <span className="text-sm font-normal text-primary" onClick={() => setActivePage('budgets')}>View All </span>
            </h2>
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-bold flex justify-between items-center">
              Vaults <span className="text-sm font-normal text-primary"onClick={() => setActivePage('vaults')}>View All</span>
            </h2>
            <div className="grid gap-4">
